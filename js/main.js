...
const createAppointment = (appointment) => {
    ...
    .then(resJSON=>{
        ...
        appointmentMessage.innerText = `Thank you ${resJSON.appointment.name}. Your appointment has been booked!`;
    })
...
document.getElementById('appointment-form').addEventListener('submit', function(e){
    ...
    let appointment = {
        ...
        service: document.getElementById('appointment-select').value,
